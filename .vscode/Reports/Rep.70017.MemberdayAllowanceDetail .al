report 70017 "Memberday Allowance Detail"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Data; wpStaffBudgetMaintenance)
        {
    ...
    rendering
    {
        ...
        {
            Type = Excel;
            LayoutFile = '.vscode/ReportLayouts/Excel/Rep.70017.MemberdayAllowanceDetail.xlsx';
            Caption = 'Memberday Allowance Detail';
            Summary = '.vscode/ReportLayouts/Excel/Rep.70017.MemberdayAllowanceDetail.xlsx';
        }
    }
